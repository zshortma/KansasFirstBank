...
[![PrimeVue Hero](https://www.primefaces.org/static/social/primevue-preview.jpg)](https://primevue.dev/)

# PrimeVue Website

PrimeVue is a rich set of premium UI Components for Vue. Visit the [PrimeVue website](https://primevue.dev/) for interactive demos, comprehensive documentation and additional resources.
