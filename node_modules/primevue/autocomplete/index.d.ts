 ...
 *
 * [Live Demo](https://www.primevue.dev/autocomplete/)
 *
 * @module autocomplete
 *
 */
 ...
 * @see {@link AutoCompleteEmitsOptions['option-select']}
 */
...
/**
 * Custom option unselect event.
 * @see {@link AutoCompleteEmitsOptions['option-unselect']}
...
export interface AutoCompleteEmitsOptions {
    ...
    /**
     * Callback to invoke when the input receives a paste event.
     * @param {ClipboardEvent} event - Browser event.
     */
