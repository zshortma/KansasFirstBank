...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, undefined, 1) : createCommentVNode("", true), _ctx.multiple ? (openBlock(), createElementBlock("ul", mergeProps({
    key: 2,
    ref: "multiContainer",
  ...
  }, undefined, 3) : createCommentVNode("", true), renderSlot(_ctx.$slots, "dropdown", {
