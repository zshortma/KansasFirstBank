  ...
  computed: {
    ...
    getMenuItemProps: function getMenuItemProps() {
      ...
      return {
        ...
        icon: mergeProps({
          "class": [this.cx('itemIcon'), isString(this.item.icon) ? this.item.icon : undefined]
        }, this.ptm('itemIcon', this.ptmOptions)),
        label: mergeProps({
          "class": this.cx('itemLabel')
        }, this.ptm('itemLabel', this.ptmOptions))
      };
    }
  }
};
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 8, ["item", "label", "icon", "props"]))], 16)) : createCommentVNode("", true);
}
