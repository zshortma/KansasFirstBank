...
export interface CarouselProps {
     ...
     * @deprecated since v5.0. Use the composition API with CarouselContent and CarouselItem instead.
     */
    value?: any | undefined;
    /**
     * Page index. Pass with `v-model:page` to keep page state in the parent (controlled mode).
     * Provide a static value (e.g. `:page="2"`) to set the initial page in uncontrolled mode.
     * Leave unset to start at page 0.
     * @defaultValue null
     */
    ...
    /**
     * Scroll-snap alignment of each slide within the viewport.
     * @defaultValue 'start'
     */
    ...
    /**
     * Strictness of scroll-snap points.
     * @defaultValue 'mandatory'
     */
    snapType?: 'mandatory' | 'proximity' | undefined;
    /**
    ...
    /**
     * When true, items render at their intrinsic width instead of a fixed page fraction.
     * @defaultValue false
     */
    ...
    /**
     * Controlled zero-based slide index; when set, the carousel scrolls to the slide with this index.
     */
...
export interface CarouselEmitsOptions {
    ...
    /**
     * Emitted when the slide changes in controlled mode.
     * @param {number} value - New slide index.
     */
    'update:slide'(value: number): void;
}
