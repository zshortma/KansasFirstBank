<template>
    ...
    >
        ...
        <template v-if="!$slots.container">
            <template v-if="!$slots.message">
                <slot name="icon">
                    ...
                    <component v-else-if="isComponentIcon(confirmation.icon)" :is="resolveIcon(confirmation.icon)" :class="cx('icon')" v-bind="ptm('icon')" />
            ...
            <component v-else :is="$slots.message" :message="confirmation" :icon="confirmation.icon ? resolveIcon(confirmation.icon) : undefined"></component>
        </template>
        <template v-if="!$slots.container" #footer>
            ...
            >
                <template v-if="rejectIcon || $slots.rejecticon">
                    <slot name="rejecticon">
                        <span :class="rejectIcon" v-bind="ptm('pcRejectButton')['icon']" data-pc-section="rejectbuttonicon" />
                    </slot>
                </template>
                {{ rejectLabel }}
            </Button>
            <Button :class="[cx('pcAcceptButton'), confirmation.acceptClass]" :autofocus="autoFocusAccept" :unstyled="unstyled" @click="accept()" v-bind="confirmation.acceptProps" :pt="ptm('pcAcceptButton')">
                <template v-if="acceptIcon || $slots.accepticon">
                    <slot name="accepticon">
                        <span :class="acceptIcon" v-bind="ptm('pcAcceptButton')['icon']" data-pc-section="acceptbuttonicon" />
                    </slot>
                </template>
                {{ acceptLabel }}
            </Button>
