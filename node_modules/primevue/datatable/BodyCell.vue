<template>
    ...
    >
        ...
        <template v-else-if="columnProp('rowReorder')">
            ...
            <Bars v-else :class="cx('reorderableRowHandle')" v-bind="getColumnPT('reorderableRowHandle')" />
        </template>
        <template v-else-if="columnProp('expander')">
            ...
            >
                ...
                <template v-else>
                    ...
                    <ChevronDown v-else-if="isRowExpanded && !expandedRowIcon" :class="cx('rowToggleIcon')" v-bind="getColumnPT('rowToggleIcon')" />
                    <span v-else-if="!isRowExpanded && collapsedRowIcon" :class="[cx('rowToggleIcon'), collapsedRowIcon]" />
                    <ChevronRight v-else-if="!isRowExpanded && !collapsedRowIcon" :class="cx('rowToggleIcon')" v-bind="getColumnPT('rowToggleIcon')" />
                </template>
            </button>
        </template>
        <template v-else-if="editMode === 'row' && columnProp('rowEditor')">
            <Button
                ...
                data-pc-group-section="rowactionbutton"
            >
                <component :is="(column.children && column.children.roweditoriniticon) || 'Pencil'" v-bind="getColumnPT('pcRowEditorInit')['icon']" />
            </Button>
            <Button
                v-if="d_editing"
                ...
                data-pc-group-section="rowactionbutton"
            >
                <component :is="(column.children && column.children.roweditorsaveicon) || 'Check'" v-bind="getColumnPT('pcRowEditorSave')['icon']" />
            </Button>
            <Button
                v-if="d_editing"
                ...
                data-pc-group-section="rowactionbutton"
            >
                <component :is="(column.children && column.children.roweditorcancelicon) || 'Times'" v-bind="getColumnPT('pcRowEditorCancel')['icon']" />
            </Button>
        </template>
