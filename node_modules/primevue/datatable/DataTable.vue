<template>
    <div :class="cx('root')" data-scrollselectors=".p-datatable-wrapper" :data-p="dataP" v-bind="ptmi('root')">
        ...
        <transition name="p-overlay-mask">
            <div v-if="loading" :class="cx('mask')" v-bind="ptm('mask')">
                ...
                <template v-else>
                    ...
                    <Spinner v-else spin :class="cx('loadingIcon')" v-bind="ptm('loadingIcon')" />
                </template>
            </div>
        </transition>
        ...
        <span v-if="reorderableColumns" ref="reorderIndicatorUp" :class="cx('rowReorderIndicatorUp')" style="position: absolute; display: none" v-bind="ptm('rowReorderIndicatorUp')">
            <component :is="$slots.rowreorderindicatorupicon || 'ArrowDown'" />
        </span>
        <span v-if="reorderableColumns" ref="reorderIndicatorDown" :class="cx('rowReorderIndicatorDown')" style="position: absolute; display: none" v-bind="ptm('rowReorderIndicatorDown')">
            <component :is="$slots.rowreorderindicatordownicon || 'ArrowUp'" />
        </span>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        onColumnResizeEnd() {
            ...
            let minWidth = parseInt(this.resizeColumnElement.style.minWidth || 15, 10);
    ...
    `;
        ...
        dataToRender(data) {
            ...
            if (_data && this.paginator) {
                ...
                const last = first + this.d_rows;
                const cache = 'dataToRenderCache' in this ? this.dataToRenderCache : null;
                ...
                const result = _data.slice(first, last);

                this.dataToRenderCache = { source: _data, first, last, result };
