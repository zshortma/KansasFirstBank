        ...
        <template v-if="!empty">
            <template v-for="(rowData, rowIndex) of value" :key="getRowKey(rowData, rowIndex)">
                <DTBodyRow
                    ...
                    :first="first"
                    :dataKey="dataKey"
                    :selected="isRowSelected(rowData)"
                    :selectionEmpty="isSelectionEmpty"
                    :selectionMode="selectionMode"
                    :contextMenu="contextMenu"
                    :contextMenuSelected="isRowSelectedWithContextMenu(rowData)"
                    ...
                    :virtualScrollerContentProps="isVirtualScrollerDisabled ? null : virtualScrollerContentProps"
...
import { equals as objectEquals, resolveFieldData } from '@primeuix/utils/object';
...
export default {
    ...
    methods: {
        ...
        isRowSelectedWithContextMenu(rowData) {
