                ...
                >
                    <div :class="cx('itemContent')" v-bind="getPTOptions('itemContent', processedItem, index)">
                        <template v-if="!templates['item']">
                            ...
                            >
                                <template v-if="!templates['itemicon']">
                                    <component v-if="isComponentIcon(processedItem.icon)" v-ripple :is="resolveIcon(processedItem.icon)" :class="cx('itemIcon')" v-bind="getPTOptions('itemIcon', processedItem, index)"></component>
                                    <span v-else-if="processedItem.icon" v-ripple :class="[cx('itemIcon'), processedItem.icon]" v-bind="getPTOptions('itemIcon', processedItem, index)"></span>
                                </template>
                                <component v-else :is="templates['itemicon']" :item="processedItem" :class="cx('itemIcon')"></component>
                            </a>
                        </template>
                        <component
                            v-else
                            :is="templates['item']"
                            :item="processedItem"
                            :icon="processedItem.icon ? resolveIcon(processedItem.icon) : undefined"
                            :index="index"
