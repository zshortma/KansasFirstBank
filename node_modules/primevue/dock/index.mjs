...
import { isString, resolve } from '@primeuix/utils/object';
import Ripple from 'primevue/ripple';
import Tooltip from 'primevue/tooltip';
import { toRaw, mergeProps, resolveDirective, openBlock, createElementBlock, createElementVNode, Fragment, renderList, withDirectives, createBlock, resolveDynamicComponent, createCommentVNode, normalizeClass, resolveComponent, createVNode } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock("li", mergeProps({
      ...
      ref_for: true
    }, $options.getPTOptions('itemLink', processedItem, index)), [!$props.templates['itemicon'] ? (openBlock(), createElementBlock(Fragment, {
      key: 0
    }, [$options.isComponentIcon(processedItem.icon) ? withDirectives((openBlock(), createBlock(resolveDynamicComponent($options.resolveIcon(processedItem.icon)), mergeProps({
      key: 0,
      "class": _ctx.cx('itemIcon')
    }, {
      ref_for: true
    }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16, ["class"])), [[_directive_ripple]]) : processedItem.icon ? withDirectives((openBlock(), createElementBlock("span", mergeProps({
      key: 1,
      "class": [_ctx.cx('itemIcon'), processedItem.icon]
    }, {
      ref_for: true
    }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16)), [[_directive_ripple]]) : createCommentVNode("", true)], 64)) : (openBlock(), createBlock(resolveDynamicComponent($props.templates['itemicon']), {
      key: 1,
      item: processedItem,
      ...
      key: 1,
      item: processedItem,
      icon: processedItem.icon ? $options.resolveIcon(processedItem.icon) : undefined,
      index: index,
      label: processedItem.label,
      props: $options.getMenuItemProps(processedItem, index)
    }, null, 8, ["item", "icon", "index", "label", "props"]))], 16)], 16, _hoisted_2);
