<template>
    <div v-if="isAdvanced" :class="cx('root')" v-bind="ptmi('root')">
        ...
        <div :class="cx('header')" v-bind="ptm('header')">
            <slot name="header" :files="files" :uploadedFiles="uploadedFiles" :chooseCallback="choose" :uploadCallback="uploader" :clearCallback="clear">
                <Button :class="chooseButtonClass" :style="style" :disabled="disabled" :unstyled="unstyled" @click="choose" @keydown.enter="choose" @focus="onFocus" @blur="onBlur" v-bind="chooseButtonProps" :pt="ptm('pcChooseButton')">
                    <slot name="chooseicon">
                        <component :is="chooseIcon ? 'span' : 'Plus'" :class="chooseIcon" aria-hidden="true" v-bind="ptm('pcChooseButton')['icon']" />
                    </slot>
                    {{ chooseButtonLabel }}
                </Button>
                <Button v-if="showUploadButton" :class="cx('pcUploadButton')" @click="uploader" :disabled="uploadDisabled" :unstyled="unstyled" v-bind="uploadButtonProps" :pt="ptm('pcUploadButton')">
                    <slot name="uploadicon">
                        <component :is="uploadIcon ? 'span' : 'Upload'" :class="uploadIcon" aria-hidden="true" v-bind="ptm('pcUploadButton')['icon']" data-pc-section="uploadbuttonicon" />
                    </slot>
                    {{ uploadButtonLabel }}
                </Button>
                <Button v-if="showCancelButton" :class="cx('pcCancelButton')" @click="clear" :disabled="cancelDisabled" :unstyled="unstyled" v-bind="cancelButtonProps" :pt="ptm('pcCancelButton')">
                    <slot name="cancelicon">
                        <component :is="cancelIcon ? 'span' : 'Times'" :class="cancelIcon" aria-hidden="true" v-bind="ptm('pcCancelButton')['icon']" data-pc-section="cancelbuttonicon" />
                    </slot>
                    {{ cancelButtonLabel }}
                </Button>
            </slot>
    ...
    <div v-else-if="isBasic" :class="cx('root')" v-bind="ptmi('root')">
        ...
        <div :class="cx('basicContent')" v-bind="ptm('basicContent')">
            <Button :class="chooseButtonClass" :style="style" :disabled="disabled" :unstyled="unstyled" @mouseup="onBasicUploaderClick" @keydown.enter="choose" @focus="onFocus" @blur="onBlur" v-bind="chooseButtonProps" :pt="ptm('pcChooseButton')">
                <slot name="chooseicon">
                    <component :is="chooseIcon ? 'span' : 'Plus'" :class="chooseIcon" aria-hidden="true" v-bind="ptm('pcChooseButton')['icon']" />
                </slot>
                {{ chooseButtonLabel }}
