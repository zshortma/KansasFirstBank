<template>
    <div :class="cx('thumbnails')" v-bind="ptm('thumbnails')">
        <div :class="cx('thumbnailContent')" v-bind="ptm('thumbnailContent')">
            ...
            >
                <component :is="templates.previousthumbnailicon || (isVertical ? 'ChevronUp' : 'ChevronLeft')" :class="cx('thumbnailPrevIcon')" v-bind="ptm('thumbnailPrevIcon')" />
            </button>
            <div :class="cx('thumbnailsViewport')" :style="{ height: isVertical ? contentHeight : '' }" v-bind="ptm('thumbnailsViewport')">
                ...
                >
                    <div
                        ...
                        :data-p-galleria-thumbnail-item-current="activeIndex === index ? '' : undefined"
                        :data-p-galleria-thumbnail-item-active="isItemActive(index) ? '' : undefined"
                        :data-p-galleria-thumbnail-item-start="firstItemAciveIndex() === index ? '' : undefined"
                        :data-p-galleria-thumbnail-item-end="lastItemActiveIndex() === index ? '' : undefined"
                    >
                        <div
                            :class="cx('thumbnail')"
            ...
            <button
                ...
                data-pc-group-section="thumbnailnavigator"
            >
                <component :is="templates.nextthumbnailicon || (isVertical ? 'ChevronDown' : 'ChevronRight')" :class="cx('thumbnailNextIcon')" v-bind="ptm('thumbnailNextIcon')" />
            </button>
        </div>
    </div>
</template>
