...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_Refresh = resolveComponent("Refresh");
  var _component_Undo = resolveComponent("Undo");
  var _component_SearchMinus = resolveComponent("SearchMinus");
  var _component_SearchPlus = resolveComponent("SearchPlus");
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.previewIcon || _ctx.indicatorIcon ? 'i' : 'Eye'), mergeProps({
    ...
    "default": withCtx(function () {
      return [$data.maskVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
        ...
        return [createVNode(_component_Refresh, normalizeProps(guardReactiveProps(_ctx.ptm('rotateRightIcon'))), null, 16)];
        ...
        return [createVNode(_component_Undo, normalizeProps(guardReactiveProps(_ctx.ptm('rotateLeftIcon'))), null, 16)];
        ...
        return [createVNode(_component_SearchMinus, normalizeProps(guardReactiveProps(_ctx.ptm('zoomOutIcon'))), null, 16)];
        ...
        return [createVNode(_component_SearchPlus, normalizeProps(guardReactiveProps(_ctx.ptm('zoomInIcon'))), null, 16)];
        ...
        return [createVNode(_component_Times, normalizeProps(guardReactiveProps(_ctx.ptm('closeIcon'))), null, 16)];
