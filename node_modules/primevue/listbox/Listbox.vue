<template>
    <div :id="$id" :class="cx('root')" @focusout="onFocusout" :data-p="containerDataP" v-bind="ptmi('root')">
        ...
        <div v-if="showCheckboxToggleAll || filter" :class="cx('header')" v-bind="ptm('header')">
            <Checkbox
                v-if="showCheckboxToggleAll"
                        ...
                        <template v-for="(option, i) of items" :key="getOptionRenderKey(option, getOptionIndex(i, getItemOptions))">
                            ...
                            >
                                <Checkbox
                                    ...
                                    :variant="checkboxVariant"
                                    :unstyled="unstyled"
                                    :pt="getPTOptions(option, getItemOptions, i, 'pcOptionCheckbox')"
                                >
                                    <template #icon="slotProps">
                                        <component v-if="$slots.optioncheckboxicon" :is="$slots.optioncheckboxicon" :checked="slotProps.checked" :class="slotProps.class" />
                                    </template>
                                </Checkbox>
                                <template v-if="checkmark">
                                    <Check v-if="isSelected(option)" :class="cx('optionCheckIcon')" v-bind="ptm('optionCheckIcon')" />
                                    <Blank v-else :class="cx('optionCheckIcon')" v-bind="ptm('optionCheckIcon')" />
                                </template>
