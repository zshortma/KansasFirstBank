 ...
 *
 * [Live Demo](https://www.primevue.dev/listbox/)
 *
 * @module listbox
 *
 */
 ...
 * @see {@link ListboxEmitsOptions['selectall-change']}
 */
export interface ListboxSelectAllChangeEvent {
    ...
    originalEvent: Event;
    /**
     * Boolean value to indicate whether all data is selected.
     */
    checked: boolean;
}
...
export interface ListboxPassThroughOptions<T = any> {
    ...
    /**
     * Used to pass attributes to the header checkbox's Checkbox component.
     */
    pcHeaderCheckbox?: ListboxPassThroughOptionType<T>;
    /**
    ...
    /**
     * Used to pass attributes to the option checkbox's Checkbox component.
     */
    pcOptionCheckbox?: ListboxPassThroughOptionType<T>;
    /**
...
export interface ListboxProps {
    ...
    /**
     * Whether all data is selected. When set, it takes precedence over the internal toggle-all state and emits select-all-change instead of mutating the model.
     * @defaultValue null
     */
...
export interface ListboxSlots {
    ...
    /**
     * Custom option checkbox icon template.
     * @param {Object} scope - option checkbox icon slot's params.
     */
    optioncheckboxicon(scope: {
        /**
         * Whether the option is selected
         */
        checked: boolean;
        /**
         * Style class of the option checkbox icon
         */
        class: any;
    }): VNode[];
    /**
    ...
    headercheckboxicon(scope: {
        ...
        checked: boolean;
        /**
         * Style class of the header checkbox icon
         */
        class: any;
    }): VNode[];
}
...
export interface ListboxEmitsOptions {
     ...
     * @param {ListboxSelectAllChangeEvent} event - Custom select all change event.
     */
    'selectall-change'(event: ListboxSelectAllChangeEvent): void;
}
