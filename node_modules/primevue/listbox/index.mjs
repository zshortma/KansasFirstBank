...
var script = {
  ...
  "extends": script$1,
  inheritAttrs: false,
  emits: ['change', 'focus', 'blur', 'filter', 'item-dblclick', 'option-dblclick', 'selectall-change'],
  list: null,
  ...
  methods: {
    ...
    onToggleAll: function onToggleAll(event) {
      ...
      if (this.selectAll !== null) {
        ...
        var value = this.allSelected ? [] : this.visibleOptions.filter(function (option) {
          ...
          return _this.getOptionValue(option);
        });
    ...
    onOptionSelectRange: function onOptionSelectRange(event) {
      ...
      if (start !== -1 && end !== -1) {
        ...
        var value = this.visibleOptions.slice(rangeStart, rangeEnd + 1).filter(function (option) {
          return _this4.isValidOption(option);
        }).map(function (option) {
          return _this4.getOptionValue(option);
        });
        this.updateModel(event, value);
      }
    },
    ...
    isSelected: function isSelected(option) {
      ...
      if (this.multiple) return (this.d_value || []).some(function (value) {
        return _this5.isEquals(value, optionValue);
      ...
      if (this.$filled) {
        if (this.multiple) {
          var _loop = function _loop() {
              var value = _this0.d_value[index];
              var matchedOptionIndex = _this0.visibleOptions.findIndex(function (option) {
                return _this0.isValidSelectedOption(option) && _this0.isEquals(value, _this0.getOptionValue(option));
              });
    ...
    removeOption: function removeOption(option) {
      ...
      return this.d_value.filter(function (val) {
        return !equals(val, _this14.getOptionValue(option), _this14.equalityKey);
      });
    },
  ...
  computed: {
    ...
    optionsListGroup: function optionsListGroup() {
      ...
      (this.options || []).forEach(function (optionGroup) {
        var optionGroupChildren = _this16.getOptionGroupChildren(optionGroup) || [];
        var filteredChildren = _this16.filterValue ? FilterService.filter(optionGroupChildren, _this16.searchFields, _this16.filterValue, _this16.filterMatchMode, _this16.filterLocale) : optionGroupChildren;
    ...
    showOptionCheckbox: function showOptionCheckbox() {
      return this.checkbox && this.multiple;
    },
    showCheckboxToggleAll: function showCheckboxToggleAll() {
      return this.checkbox && this.multiple && this.showToggleAll;
    },
    checkboxVariant: function checkboxVariant() {
    ...
    allSelected: function allSelected() {
      ...
      return this.selectAll !== null ? this.selectAll : isNotEmpty(this.visibleOptions) && this.visibleOptions.every(function (option) {
        return _this18.isOptionGroup(option) || _this18.isOptionDisabled(option) || _this18.isSelected(option);
      });
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
  ...
  })], 16)) : createCommentVNode("", true), $options.showCheckboxToggleAll || _ctx.filter ? (openBlock(), createElementBlock("div", mergeProps({
    key: 1,
    "class": _ctx.cx('header')
  }, _ctx.ptm('header')), [$options.showCheckboxToggleAll ? (openBlock(), createBlock(_component_Checkbox, {
    key: 0,
    modelValue: $options.allSelected,
    binary: true,
    "class": normalizeClass(_ctx.cx('optionCheckIcon')),
    disabled: _ctx.disabled,
    tabindex: -1,
    variant: $options.checkboxVariant,
    ...
    _: 1
  }, 8, ["modelValue", "class", "disabled", "variant", "aria-label", "onChange", "unstyled", "pt"])) : createCommentVNode("", true), _ctx.filter ? (openBlock(), createBlock(_component_IconField, {
    key: 1,
    unstyled: _ctx.unstyled,
    ...
    _: 3
  }, 8, ["unstyled", "pt"])) : createCommentVNode("", true), _ctx.filter ? (openBlock(), createElementBlock("span", mergeProps({
    key: 2,
    role: "status",
    "aria-live": "polite",
    ...
    content: withCtx(function (_ref) {
      ...
      return [createElementVNode("ul", mergeProps({
        ...
        return openBlock(), createElementBlock(Fragment, {
        ...
        }), [$options.showOptionCheckbox ? (openBlock(), createBlock(_component_Checkbox, {
          key: 0,
          ...
          variant: $options.checkboxVariant,
          unstyled: _ctx.unstyled,
          pt: $options.getPTOptions(option, getItemOptions, i, 'pcOptionCheckbox')
        }, {
          icon: withCtx(function (slotProps) {
            return [_ctx.$slots.optioncheckboxicon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.optioncheckboxicon), {
              key: 0,
              checked: slotProps.checked,
              "class": normalizeClass(slotProps["class"])
            }, null, 8, ["checked", "class"])) : createCommentVNode("", true)];
          ...
          _: 1
        }, 8, ["defaultValue", "class", "variant", "unstyled", "pt"])) : createCommentVNode("", true), _ctx.checkmark ? (openBlock(), createElementBlock(Fragment, {
          key: 1
          ...
          ref_for: true
        }, _ctx.ptm('optionCheckIcon')), null, 16, ["class"]))], 64)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "option", {
          option: option,
