        ...
        <template v-for="(processedItem, index) of items" :key="getItemKey(processedItem)">
            ...
            >
                <div :class="cx('itemContent')" @click="onItemClick($event, processedItem)" @mouseenter="onItemMouseEnter($event, processedItem)" v-bind="getPTOptions(processedItem, index, 'itemContent')">
                    <template v-if="!templates.item">
                        <a v-ripple :href="getItemProp(processedItem, 'url')" :class="cx('itemLink')" :target="getItemProp(processedItem, 'target')" tabindex="-1" v-bind="getPTOptions(processedItem, index, 'itemLink')">
                            ...
                            <component v-else-if="isComponentIcon(getItemProp(processedItem, 'icon'))" :is="resolveIcon(getItemProp(processedItem, 'icon'))" :class="cx('itemIcon')" v-bind="getPTOptions(processedItem, index, 'itemIcon')" />
                            ...
                            <template v-if="isItemGroup(processedItem)">
                                ...
                                <component v-else :is="horizontal || mobileActive ? 'AngleDown' : 'AngleRight'" :class="cx('submenuIcon')" v-bind="getPTOptions(processedItem, index, 'submenuIcon')" />
                            </template>
                        </a>
                    </template>
                    <component
                        ...
                        :icon="getItemProp(processedItem, 'icon') ? resolveIcon(getItemProp(processedItem, 'icon')) : undefined"
                ...
                <transition name="p-anchored-overlay">
                    <div v-if="isItemVisible(processedItem) && isItemGroup(processedItem)" v-show="isItemActive(processedItem)" :class="cx('overlay')" v-bind="ptm('overlay')">
