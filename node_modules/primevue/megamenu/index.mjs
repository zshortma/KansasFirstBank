...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      ref_for: true
    }, $options.getPTOptions(processedItem, index, 'submenuIcon')), null, 16, ["active", "class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.horizontal || $props.mobileActive ? 'AngleDown' : 'AngleRight'), mergeProps({
      key: 1,
      "class": _ctx.cx('submenuIcon')
    }, {
      ref_for: true
    ...
    }, null, 8, ["item", "icon", "hasSubmenu", "label", "props"]))], 16, _hoisted_3), createVNode(Transition, {
      name: "p-anchored-overlay"
    }, {
      "default": withCtx(function () {
        return [$options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
          key: 0,
        ...
        }), 128))], 16)], 16)), [[vShow, $options.isItemActive(processedItem)]]) : createCommentVNode("", true)];
      }),
      _: 2
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    }, _ctx.ptm('button')), [renderSlot(_ctx.$slots, "buttonicon", {}, function () {
    ...
    "default": withCtx(function () {
      return [withDirectives(createVNode(_component_MegaMenuSub, {
      ...
      }, null, 8, ["id", "tabindex", "aria-label", "aria-labelledby", "aria-disabled", "aria-orientation", "aria-activedescendant", "menuId", "focusedItemId", "items", "horizontal", "templates", "activeItem", "mobileActive", "style", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter"]), [[vShow, !$data.queryMatches || $data.mobileActive]])];
    }),
    _: 1
