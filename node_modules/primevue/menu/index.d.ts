 ...
 *
 * [Live Demo](https://www.primevue.dev/menu/)
 *
 * @module menu
 *
 */
...
import { Component, TransitionProps, VNode } from 'vue';
...
export interface MenuPassThroughOptions {
    ...
    /**
     * Used to pass attributes to the submenu label's DOM element (non-toggleable group headers).
     */
    submenuLabel?: MenuPassThroughOptionType;
    /**
     * Used to pass attributes to the nested submenu list's DOM element.
     */
    submenuList?: MenuPassThroughOptionType;
    /**
    ...
    /**
     * Used to pass attributes to the item submenu toggle icon's DOM element (toggleable items).
     */
    itemSubmenuIcon?: MenuPassThroughOptionType;
    /**
...
/**
 * Expansion state map where each key matches a toggleable submenu item's `key` field,
 * or falls back to its index-derived DOM id when no `key` is provided.
 */
export interface MenuExpandedKeys {
    [key: string]: boolean;
}
...
export interface MenuState {
    ...
    focused: boolean;
    /**
     * DOM id of the focused menuitem, or `null` when no item is focused.
     * @defaultValue null
     */
    focusedOptionId: string | null;
    /**
     * Internal expansion state used when the component runs in uncontrolled mode.
     * @defaultValue {}
     */
    d_expandedKeys: MenuExpandedKeys;
}
...
export interface MenuProps {
     ...
     * Pair with `@update:expandedKeys` or `v-model:expandedKeys`.
     */
    expandedKeys?: MenuExpandedKeys | undefined;
    /**
...
export interface MenuSlots {
    ...
    /**
     * Custom submenu toggle icon template for toggleable submenus.
...
export interface MenuEmitsOptions {
    ...
    hide(): void;
    /**
     * Emitted when the user toggles a toggleable submenu.
     * @param {MenuExpandedKeys} value - New expansion state.
     */
    'update:expandedKeys'(value: MenuExpandedKeys): void;
}
