...
import { toRaw, mergeProps, resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, renderList, createElementVNode, withDirectives, createBlock, resolveDynamicComponent, normalizeClass, createCommentVNode, toDisplayString, createVNode, Transition, withCtx, normalizeStyle, vShow, renderSlot, normalizeProps, guardReactiveProps } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    }, null, 8, ["root", "active", "class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.root ? 'AngleDown' : 'AngleRight'), mergeProps({
      key: 1,
    ...
    }, null, 8, ["item", "root", "hasSubmenu", "label", "icon", "props"]))], 16, _hoisted_2), createVNode(Transition, {
      name: "p-anchored-overlay"
    }, {
      "default": withCtx(function () {
        return [$options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? withDirectives((openBlock(), createBlock(_component_MenubarSub, {
          key: 0,
        ...
        }, null, 8, ["id", "menuId", "style", "focusedItemId", "items", "mobileActive", "activeItemPath", "templates", "level", "aria-labelledby", "pt", "unstyled"])), [[vShow, $options.isItemActive(processedItem)]]) : createCommentVNode("", true)];
      }),
      _: 2
    }, 1024)], 16, _hoisted_1$1)) : createCommentVNode("", true), $options.isItemVisible(processedItem) && $options.getItemProp(processedItem, 'separator') ? (openBlock(), createElementBlock("li", mergeProps({
      key: 1,
      id: $options.getItemId(processedItem),
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    key: 0,
    "class": _ctx.cx('start')
  }, _ctx.ptm('start')), [renderSlot(_ctx.$slots, "start")], 16)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "button", {
    id: _ctx.$id,
    ...
    }, _objectSpread(_objectSpread({}, _ctx.buttonProps), _ctx.ptm('button'))), [renderSlot(_ctx.$slots, "buttonicon", {}, function () {
      return [createVNode(_component_Bars, normalizeProps(guardReactiveProps(_ctx.ptm('buttonicon'))), null, 16)];
    })], 16, _hoisted_1)) : createCommentVNode("", true)];
  }), createVNode(Transition, {
    name: "p-anchored-overlay"
  }, {
    "default": withCtx(function () {
      return [withDirectives(createVNode(_component_MenubarSub, {
      ...
      }, null, 8, ["id", "items", "templates", "mobileActive", "aria-activedescendant", "menuId", "focusedItemId", "activeItemPath", "aria-labelledby", "aria-label", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter", "onItemMousemove"]), [[vShow, !$data.queryMatches || $data.mobileActive]])];
    }),
    _: 1
