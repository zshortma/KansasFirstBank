<template>
    <transition name="p-message" appear v-bind="ptm('transition')">
        <div v-if="visible" :class="cx('root')" role="alert" aria-live="assertive" aria-atomic="true" :data-p="dataP" v-bind="ptmi('root')">
                ...
                <div v-else :class="cx('content')" :data-p="dataP" v-bind="ptm('content')">
                    ...
                    <button v-if="closable" v-ripple :class="cx('closeButton')" :aria-label="closeAriaLabel" type="button" @click="close($event)" :data-p="dataP" v-bind="{ ...closeButtonProps, ...ptm('closeButton') }">
                        <slot name="closeicon">
                            ...
                            <Times v-else :class="[cx('closeIcon'), closeIcon]" :data-p="dataP" v-bind="ptm('closeIcon')" />
                        </slot>
                    </button>
                </div>
            </div>
