            ...
            <div :class="cx('label')" :data-p="labelDataP" v-bind="ptm('label')">
                <slot name="value" :value="d_value" :placeholder="placeholder">
                    ...
                    <template v-else-if="display === 'chip'">
                        ...
                        <template v-else-if="!d_value || d_value.length === 0">{{ placeholder || 'empty' }}</template>
                    ...
                    <div v-if="(showToggleAll && selectionLimit == null) || filter" :class="cx('header')" v-bind="ptm('header')">
                        ...
                        >
                            <template #icon="slotProps">
                                ...
                                <component v-else-if="slotProps.checked" :is="checkboxIcon ? 'span' : 'Check'" :class="[slotProps.class, { [checkboxIcon]: slotProps.checked }]" v-bind="getHeaderCheckboxPTOptions('pcHeaderCheckbox.icon')" />
                            </template>
                        </Checkbox>
