 ...
 *
 * [Live Demo](https://primevue.dev/orderlist)
 *
 * @module orderlist
 *
 */
...
/**
 * Custom filter event
 * @see {@link OrderListEmitsOptions.filter}
 */
...
export interface OrderListSlots {
    ...
    filtericon(): VNode[];
    /**
     * Custom empty filter template when filtering does not return any results.
     */
    emptyfilter(): VNode[];
    /**
     * Custom empty template when there are no options available.
     */
    empty(): VNode[];
    /**
...
export interface OrderListEmitsOptions {
     ...
     */
    filter(event: OrderListFilterEvent): void;
}
 ...
 *
 * [Live Demo](https://www.primevue.dev/orderlist/)
 * --- ---
