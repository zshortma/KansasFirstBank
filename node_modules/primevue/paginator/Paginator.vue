                ...
                <div :class="cx('content')" v-bind="ptm('content')">
                    <template v-for="item in value" :key="item">
                        ...
                        <LastPageLink
                            ...
                            :template="$slots.lasticon"
                            @click="changePageToLast($event)"
                            :disabled="isLastPage || empty"
                            :unstyled="unstyled"
                            :pt="ptForward"
                        />
                        <PageLinks v-else-if="item === 'PageLinks'" :aria-label="getAriaLabel('pageLabel')" :value="pageLinks" :page="page" @click="changePageLink($event)" :unstyled="unstyled" :pt="ptForward" />
                        <CurrentPageReport
                        ...
                        <JumpToPageDropdown
                            ...
                            :pt="ptForward"
                        />
                        <JumpToPageInput v-else-if="item === 'JumpToPageInput'" :page="currentPage" @page-change="changePage($event)" :disabled="empty" :unstyled="unstyled" :pt="ptForward" />
                    </template>
                </div>
