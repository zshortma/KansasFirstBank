                ...
                >
                    <div :class="cx('headerContent')" v-bind="getPTOptions('headerContent', item, index)">
                        <template v-if="!$slots.item">
                            <a :href="getItemProp(item, 'url')" :class="cx('headerLink')" :tabindex="-1" v-bind="getPTOptions('headerLink', item, index)">
                                <slot v-if="getItemProp(item, 'items')" name="submenuicon" :active="isItemActive(item)">
                                    <component :is="isItemActive(item) ? 'ChevronDown' : 'ChevronRight'" :class="cx('submenuIcon')" v-bind="getPTOptions('submenuIcon', item, index)" />
                                </slot>
                                <component v-if="$slots.headericon" :is="$slots.headericon" :item="item" :class="cx('headerIcon')" />
                                <component v-else-if="isComponentIcon(getItemProp(item, 'icon'))" :is="resolveIcon(getItemProp(item, 'icon'))" :class="cx('headerIcon')" v-bind="getPTOptions('headerIcon', item, index)" />
                        ...
                        <component
                            ...
                            :is="$slots.item"
                            :item="item"
                            :icon="getItemProp(item, 'icon') ? resolveIcon(getItemProp(item, 'icon')) : undefined"
                            :root="true"
...
import { equals, isNotEmpty, isString, resolve } from '@primeuix/utils/object';
