                    ...
                    <template v-if="!templates.item">
                        <a v-ripple :href="getItemProp(processedItem, 'url')" :class="cx('itemLink')" :target="getItemProp(processedItem, 'target')" tabindex="-1" v-bind="getPTOptions('itemLink', processedItem, index)">
                            <template v-if="isItemGroup(processedItem)">
                                ...
                                <component v-else :is="isItemActive(processedItem) ? 'ChevronDown' : 'ChevronRight'" :class="cx('submenuIcon')" v-bind="getPTOptions('submenuIcon', processedItem, index)" />
                            </template>
                            <component v-if="templates.itemicon" :is="templates.itemicon" :item="processedItem.item" :class="cx('itemIcon')" />
                            <component v-else-if="isComponentIcon(getItemProp(processedItem, 'icon'))" :is="resolveIcon(getItemProp(processedItem, 'icon'))" :class="cx('itemIcon')" v-bind="getPTOptions('itemIcon', processedItem, index)" />
