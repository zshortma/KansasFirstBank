 ...
 *
 * [Live Demo](https://primevue.dev/picklist)
 *
 * @module picklist
 *
 */
...
/**
 * Custom filter event.
 * @see {@link PickListEmitsOptions.filter}
 */
export interface PickListFilterEvent {
    ...
    filterValue: any[];
    /**
     * The list that was filtered; 'source' or 'target'
     */
    type: 'source' | 'target';
}
...
export interface PickListProps {
    ...
    /**
     * When specified displays an input field to filter the items, the value is checked against this property.
     */
    ...
    /**
     * Whether to show the filter input for the source list when filtering is enabled.
     * @defaultValue true
     */
    showSourceFilter?: boolean | undefined;
    /**
     * Whether to show the filter input for the target list when filtering is enabled.
     * @defaultValue true
     */
    showTargetFilter?: boolean | undefined;
    /**
     * Placeholder text on the source filter input.
     */
    sourceFilterPlaceholder?: string | undefined;
    /**
     * Placeholder text on the target filter input.
     */
    targetFilterPlaceholder?: string | undefined;
    /**
     * Text to be displayed in hidden accessible field when filtering returns any results.
     */
    filterMessage?: string | undefined;
    /**
     * Text to be displayed when filtering does not return any results.
     */
    emptyFilterMessage?: string | undefined;
    /**
     * Text to be displayed when there are no options available.
     */
...
export interface PickListSlots {
    ...
    targetheader(): VNode[];
    /**
     * Custom source footer template.
     */
    sourcefooter(): VNode[];
    /**
     * Custom target footer template.
     */
    targetfooter(): VNode[];
    /**
     * Custom source filter icon template.
     */
    sourcefiltericon(): VNode[];
    /**
     * Custom target filter icon template.
     */
    targetfiltericon(): VNode[];
    /**
     * Custom source empty filter template when filtering does not return any results.
     */
    sourceemptyfilter(): VNode[];
    /**
     * Custom target empty filter template when filtering does not return any results.
     */
    targetemptyfilter(): VNode[];
    /**
     * Custom source empty template when there are no options available.
     */
    sourceempty(): VNode[];
    /**
     * Custom target empty template when there are no options available.
     */
    targetempty(): VNode[];
    /**
...
export interface PickListEmitsOptions {
    ...
    /**
     * Callback to invoke when a list is filtered.
     * @param {PickListFilterEvent} event - Custom filter event.
     */
    filter(event: PickListFilterEvent): void;
    /**
 ...
 *
 * [Live Demo](https://www.primevue.dev/picklist/)
 * --- ---
