...
import { setAttribute, find } from '@primeuix/utils/dom';
...
var script = {
  ...
  "extends": script$1,
  inheritAttrs: false,
  emits: ['update:modelValue', 'reorder', 'update:selection', 'selection-change', 'move-to-target', 'move-to-source', 'move-all-to-target', 'move-all-to-source', 'focus', 'blur', 'filter'],
  itemTouched: false,
  reorderDirection: null,
  reorderedListIndex: null,
  styleElement: null,
  media: null,
  ...
  updated: function updated() {
    if (this.reorderDirection) {
      this.updateListScroll(this.reorderedListIndex);
      this.reorderDirection = null;
      this.reorderedListIndex = null;
    }
  },
  ...
  methods: {
    ...
    onFilter: function onFilter(event, type) {
      this.$emit('filter', {
    ...
    onReorderUpdate: function onReorderUpdate(event, value, listIndex) {
      this.reorderedListIndex = listIndex;
    ...
    moveUp: function moveUp(event, listIndex) {
      if (this.d_selection && this.d_selection[listIndex]) {
        ...
        var sortedSelection = this.sortByIndexInList(selectionList, valueList);
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (selectedItemIndex > 0 && findIndexInList(valueList[selectedItemIndex - 1], selectionList) === -1) {
    ...
    moveTop: function moveTop(event, listIndex) {
      if (this.d_selection && this.d_selection[listIndex]) {
        var valueList = _toConsumableArray(this.modelValue[listIndex]);
        var selectionList = this.d_selection[listIndex];
        var sortedSelection = this.sortByIndexInList(selectionList, valueList).reverse();
      ...
      if (this.d_selection && this.d_selection[listIndex]) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            var selectedItemIndex = findIndexInList(selectedItem, valueList);
            if (selectedItemIndex < valueList.length - 1 && findIndexInList(valueList[selectedItemIndex + 1], selectionList) === -1) {
              var movedItem = valueList[selectedItemIndex];
              var temp = valueList[selectedItemIndex + 1];
              valueList[selectedItemIndex + 1] = movedItem;
              valueList[selectedItemIndex] = temp;
    ...
    updateListScroll: function updateListScroll(listIndex) {
      var _this = this;
      var listboxRef = listIndex === 0 ? this.$refs.sourceList : this.$refs.targetList;
      var selection = this.d_selection && this.d_selection[listIndex];
      if (!listboxRef || !selection || !selection.length) {
        return;
      }
      var indexes = selection.map(function (item) {
        return findIndexInList(item, _this.modelValue[listIndex]);
      });
      ...
      listboxRef.scrollInView(targetIndex);
    },
    ...
    bindMediaChangeListener: function bindMediaChangeListener() {
      ...
      if (this.media && !this.mediaChangeListener) {
        this.mediaChangeListener = function (event) {
          _this2.viewChanged = event.matches;
        };
  ...
  computed: {
    filterFieldsValue: function filterFieldsValue() {
      if (!this.filterBy) return null;
      return Array.isArray(this.filterBy) ? this.filterBy : this.filterBy.split(',').map(function (field) {
        return field.trim();
      });
    },
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "moveupicon", {}, function () {
        return [createVNode(_component_AngleUp, mergeProps(_ctx.ptm('pcSourceMoveUpButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movetopicon", {}, function () {
        return [createVNode(_component_AngleDoubleUp, mergeProps(_ctx.ptm('pcSourceMoveTopButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movedownicon", {}, function () {
        return [createVNode(_component_AngleDown, mergeProps(_ctx.ptm('pcSourceMoveDownButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movebottomicon", {}, function () {
        return [createVNode(_component_AngleDoubleDown, mergeProps(_ctx.ptm('pcSourceMoveBottomButton')['icon'], {
    ...
    filter: !!_ctx.filterBy && _ctx.showSourceFilter,
    filterPlaceholder: _ctx.sourceFilterPlaceholder,
    filterLocale: _ctx.filterLocale,
    filterMatchMode: _ctx.filterMatchMode,
    filterFields: $options.filterFieldsValue,
    ...
    onFilter: _cache[8] || (_cache[8] = function ($event) {
      return $options.onFilter($event, 'source');
    }),
    ...
    key: "0"
  } : undefined, _ctx.$slots.sourcefiltericon ? {
    name: "filtericon",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "sourcefiltericon")];
    }),
    key: "1"
  } : undefined, _ctx.$slots.sourceempty ? {
    name: "empty",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "sourceempty")];
    }),
    key: "2"
  } : undefined, _ctx.$slots.sourceemptyfilter ? {
    name: "emptyfilter",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "sourceemptyfilter")];
    }),
    key: "3"
  } : undefined, _ctx.$slots.sourcefooter ? {
    name: "footer",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "sourcefooter")];
    }),
    key: "4"
  } : undefined]), 1032, ["id", "modelValue", "options", "metaKeySelection", "listStyle", "scrollHeight", "tabindex", "dataKey", "autoOptionFocus", "focusOnHover", "striped", "disabled", "filter", "filterPlaceholder", "filterLocale", "filterMatchMode", "filterFields", "filterMessage", "emptyFilterMessage", "emptyMessage", "pt", "unstyled"])], 16), createElementVNode("div", mergeProps({
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movetotargeticon", {
        ...
        return [(openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? 'AngleDown' : 'AngleRight'), mergeProps(_ctx.ptm('pcMoveToTargetButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movealltotargeticon", {
        ...
        return [(openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? 'AngleDoubleDown' : 'AngleDoubleRight'), mergeProps(_ctx.ptm('pcMoveAllToTargetButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movetosourceicon", {
        ...
        return [(openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? 'AngleUp' : 'AngleLeft'), mergeProps(_ctx.ptm('pcMoveToSourceButton')['icon'], {
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movealltosourceicon", {
        ...
        return [(openBlock(), createBlock(resolveDynamicComponent($data.viewChanged ? 'AngleDoubleUp' : 'AngleDoubleLeft'), mergeProps(_ctx.ptm('pcMoveAllToSourceButton')['icon'], {
    ...
    striped: _ctx.striped,
    disabled: _ctx.disabled,
    filter: !!_ctx.filterBy && _ctx.showTargetFilter,
    filterPlaceholder: _ctx.targetFilterPlaceholder,
    filterLocale: _ctx.filterLocale,
    filterMatchMode: _ctx.filterMatchMode,
    filterFields: $options.filterFieldsValue,
    filterMessage: _ctx.filterMessage,
    ...
    onItemDblclick: _cache[12] || (_cache[12] = function ($event) {
      return $options.onItemDblClick($event, 1);
    }),
    onFilter: _cache[13] || (_cache[13] = function ($event) {
      return $options.onFilter($event, 'target');
    }),
    pt: _ctx.ptm('pcListbox'),
    unstyled: _ctx.unstyled,
    "data-pc-group-section": "list"
    ...
    key: "0"
  } : undefined, _ctx.$slots.targetfiltericon ? {
    name: "filtericon",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "targetfiltericon")];
    }),
    key: "1"
  } : undefined, _ctx.$slots.targetempty ? {
    name: "empty",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "targetempty")];
    }),
    key: "2"
  } : undefined, _ctx.$slots.targetemptyfilter ? {
    name: "emptyfilter",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "targetemptyfilter")];
    }),
    key: "3"
  } : undefined, _ctx.$slots.targetfooter ? {
    name: "footer",
    fn: withCtx(function () {
      return [renderSlot(_ctx.$slots, "targetfooter")];
    }),
    key: "4"
  } : undefined]), 1032, ["id", "modelValue", "options", "metaKeySelection", "listStyle", "scrollHeight", "tabindex", "dataKey", "autoOptionFocus", "focusOnHover", "striped", "disabled", "filter", "filterPlaceholder", "filterLocale", "filterMatchMode", "filterFields", "filterMessage", "emptyFilterMessage", "emptyMessage", "pt", "unstyled"])], 16), _ctx.showTargetControls ? (openBlock(), createElementBlock("div", mergeProps({
    key: 1,
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "moveupicon", {}, function () {
        return [createVNode(_component_AngleUp, mergeProps(_ctx.ptm('pcTargetMoveUpButton')['icon'], {
          "data-pc-section": "moveupicon"
        }), null, 16)];
      })];
    }),
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movetopicon", {}, function () {
        return [createVNode(_component_AngleDoubleUp, mergeProps(_ctx.ptm('pcTargetMoveTopButton')['icon'], {
          "data-pc-section": "movetopicon"
        }), null, 16)];
      })];
    }),
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movedownicon", {}, function () {
        return [createVNode(_component_AngleDown, mergeProps(_ctx.ptm('pcTargetMoveDownButton')['icon'], {
          "data-pc-section": "movedownicon"
        }), null, 16)];
      })];
    }),
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "movebottomicon", {}, function () {
        return [createVNode(_component_AngleDoubleDown, mergeProps(_ctx.ptm('pcTargetMoveBottomButton')['icon'], {
          "data-pc-section": "movebottomicon"
        }), null, 16)];
      })];
    }),
