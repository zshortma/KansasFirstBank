        ...
        <template v-for="(option, index) of options" :key="getOptionRenderKey(option)">
            ...
            >
                <template v-if="$slots.option" #default>
                    <slot name="option" :option="option" :index="index" :icon="option.icon ? resolveIcon(option.icon) : undefined">
...
import { equals, isString, resolveFieldData } from '@primeuix/utils/object';
