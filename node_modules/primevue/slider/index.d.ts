 ...
 *
 * [Live Demo](https://www.primevue.dev/slider/)
 *
 * @module slider
 *
 */
...
export interface SliderPassThroughOptions {
     ...
     */
    input?: SliderPassThroughOptionType;
    /**
...
export interface SliderProps {
    ...
    /**
     * When present, the component cannot be edited while it is still focusable and visually unchanged.
     * @defaultValue false
     */
    readonly?: boolean | undefined;
    /**
     * When present and `range` is enabled, disables only the minimum (start) handle while keeping the maximum handle interactive.
     * @defaultValue false
     */
    disabledMinHandle?: boolean | undefined;
    /**
     * When present and `range` is enabled, disables only the maximum (end) handle while keeping the minimum handle interactive.
     * @defaultValue false
     */
    disabledMaxHandle?: boolean | undefined;
    /**
     * The minimum permitted steps between multiple handles in range mode.
     * @defaultValue 0
     */
    minStepsBetweenHandles?: number | undefined;
    /**
     * Identifier of the underlying hidden input element. In range mode, applied to the first handle's input.
     */
    inputId?: string | undefined;
    /**
     * Style class of the hidden input element.
     */
    inputClass?: string | object | undefined;
    /**
     * Inline style of the hidden input element.
     */
