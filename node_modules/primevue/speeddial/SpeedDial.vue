        ...
        <slot name="button" :visible="d_visible" :toggleCallback="onClick">
            ...
            >
                <slot name="icon" :visible="d_visible">
                    <component v-if="d_visible && !!hideIcon" :is="hideIcon ? 'span' : 'Plus'" :class="hideIcon" v-bind="ptm('pcButton')['icon']" data-pc-section="icon" />
                    <component v-else :is="showIcon ? 'span' : 'Plus'" :class="d_visible && !!hideIcon ? hideIcon : showIcon" v-bind="ptm('pcButton')['icon']" data-pc-section="icon" />
                </slot>
            </Button>
        </slot>
                        ...
                        >
                            <template v-if="item.icon">
                                <slot name="itemicon" :item="item">
                                    <component v-if="isComponentIcon(item.icon)" :is="resolveIcon(item.icon)" v-bind="getPTOptions(`${$id}_${index}`, 'actionIcon')" />
                                    <span v-else-if="item.icon" :class="item.icon" v-bind="getPTOptions(`${$id}_${index}`, 'actionIcon')"></span>
                                </slot>
                            </template>
                        </Button>
                    </template>
                    <component v-else :is="$slots.item" :item="item" :icon="item.icon ? resolveIcon(item.icon) : undefined" :onClick="(event) => onItemClick(event, item)" :toggleCallback="(event) => onItemClick(event, item)"></component>
                </li>
            </template>
        </ul>
    </div>
