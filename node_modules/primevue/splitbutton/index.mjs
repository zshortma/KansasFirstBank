...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    _: 3
  }, 16, ["class", "disabled", "severity", "text", "outlined", "size", "fluid", "aria-label", "onClick", "pt", "unstyled"]), createVNode(_component_PVSButton, mergeProps({
    ref: "button",
    type: "button",
    iconOnly: "",
    ...
    "default": withCtx(function () {
      return [renderSlot(_ctx.$slots, "dropdownicon", {}, function () {
        return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.menuButtonIcon || _ctx.dropdownIcon ? 'span' : 'ChevronDown'), mergeProps({
          "class": _ctx.dropdownIcon || _ctx.menuButtonIcon
