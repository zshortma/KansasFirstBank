 ...
 *
 * [Live Demo](https://www.primevue.dev/splitter/)
 *
 * @module splitter
 *
 */
 ...
 * @see {@link SplitterEmitsOptions.collapse}
 */
export interface SplitterCollapseEvent {
    /**
...
export interface SplitterState {
    /**
     * Current sizes of the panels as percentages.
     */
    panelSizes: number[];
    /**
     * Whether the user is currently dragging a gutter.
     */
    resizing: boolean;
}
...
export interface SplitterProps {
    ...
    /**
     * Sizes of the panels as percentages. When provided, makes the component controlled via `v-model:sizes`.
     */
...
export interface SplitterEmitsOptions {
     ...
     */
    collapse(event: SplitterCollapseEvent): void;
    /**
     * Emitted when the sizes change; enables `v-model:sizes`.
     * @param {number[]} sizes - Current panel sizes as percentages.
     */
