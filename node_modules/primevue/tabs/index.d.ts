 ...
 *
 * [Live Demo](https://www.primevue.dev/tabs/)
 *
 * @module tabs
 *
 */
...
export interface TabsProps {
    ...
    /**
     * Whether to display navigation buttons when the tablist overflows.
     * @defaultValue true
     */
    ...
    /**
     * Defines how the active tab is scrolled into view when it changes.
     * - `'nearest'`: scrolls only if the tab is clipped or too close to an edge, with padding.
     * - `'center'`: always centers the active tab in the viewport.
     * - `function`: a custom scroll function receiving the content element and active tab element.
     * @defaultValue 'nearest'
     */
    scrollStrategy?: 'nearest' | 'center' | ((content: HTMLElement, tab: HTMLElement) => void) | undefined;
    /**
...
export interface TabsSlots {
    ...
    default(): VNode[];
    /**
     * Previous button icon template for the scroll navigation.
     */
    previcon(): VNode[];
    /**
     * Next button icon template for the scroll navigation.
     */
    nexticon(): VNode[];
}
