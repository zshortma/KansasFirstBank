<template>
    <transition name="p-anchored-overlay" :css="!mobileActive" @enter="onEnter" v-bind="ptm('menu.transition')">
                        ...
                        <template v-if="!templates.item">
                            <a v-ripple :href="getItemProp(processedItem, 'url')" :class="cx('itemLink')" :target="getItemProp(processedItem, 'target')" tabindex="-1" v-bind="getPTOptions(processedItem, index, 'itemLink')">
                                ...
                                <template v-if="getItemProp(processedItem, 'items')">
                                    ...
                                    <AngleRight v-else :class="cx('submenuIcon')" v-bind="getPTOptions(processedItem, index, 'submenuIcon')" />
                                </template>
                            </a>
                        </template>
                        <component
...
export default {
    ...
    computed: {
        mobileActive() {
            return !!this.$pcTieredMenu?.queryMatches;
        }
    },
    components: {
