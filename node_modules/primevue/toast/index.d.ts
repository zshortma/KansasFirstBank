 ...
 *
 * [Live Demo](https://www.primevue.dev/toast/)
 *
 * @module toast
 *
 */
...
export interface ToastMessageOptions {
    ...
    /**
     * Icon of the message, applied as a class on the message icon element (e.g. 'pi pi-check'). Overrides the default severity icon.
     */
...
/**
 * Defines stacked toast height entry in Toast component.
 */
export interface ToastStackHeight {
    /**
     * Index of the toast within the messages collection.
     */
    index: number;
    /**
     * Measured height of the toast element in pixels.
     */
    height: number;
}
...
export interface ToastState {
    ...
    messages: any[];
    /**
     * Whether the stack is currently expanded on hover.     * @defaultValue false
     */
    expanded: boolean;
    /**
     * Number of toasts currently in their leave transition.     * @defaultValue 0
     */
    removingCount: number;
    /**
     * Measured heights of stacked toasts used for layout.     */
    heights: ToastStackHeight[];
    /**
     * Whether a pointer interaction is currently active within the stack.     * @defaultValue false
     */
...
export interface ToastProps {
    ...
    /**
     * Display mode of the toast. In stacked mode, toasts overlap and expand on hover.
     * @defaultValue stacked
     */
    mode?: 'expanded' | 'stacked' | undefined;
    /**
     * Gap between stacked toast items in pixels.     * @defaultValue 12
     */
    gap?: number | undefined;
    /**
     * Maximum number of visible toasts in the stack.     * @defaultValue 3
     */
    ...
    /**
     * Icon to display in the toast with secondary severity.
     */
    secondaryIcon?: string | undefined;
    /**
     * Icon to display in the toast with contrast severity.
     */
    contrastIcon?: string | undefined;
    /**
