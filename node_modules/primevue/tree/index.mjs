...
import { isString, isFunction, resolveFieldData } from '@primeuix/utils/object';
import IconField from 'primevue/iconfield';
import InputIcon from 'primevue/inputicon';
import InputText from 'primevue/inputtext';
import BaseComponent from '@primevue/core/basecomponent';
import TreeStyle from 'primevue/tree/style';
import { reactive, toRaw, resolveComponent, resolveDirective, openBlock, createElementBlock, mergeProps, normalizeClass, createCommentVNode, createElementVNode, withDirectives, Fragment, createBlock, resolveDynamicComponent, withCtx, withModifiers, createTextVNode, toDisplayString, renderList, createVNode, Transition, renderSlot } from 'vue';
  ...
  methods: {
    ...
    onNodeDrop: function onNodeDrop(event) {
      ...
      if (this.isDroppable) {
        ...
        var position = this.dropPosition;
        var dropIndex = position > 0 ? this.index + 1 : this.index;
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("li", mergeProps({
  ...
  }, null, 8, ["node", "expanded", "class"])) : (openBlock(), createBlock(_component_Spinner, mergeProps({
    key: 1,
    ...
    expanded: $options.expanded,
    "class": normalizeClass(_ctx.cx('nodeToggleIcon'))
  }, null, 8, ["node", "expanded", "class"])) : $options.expanded ? (openBlock(), createBlock(resolveDynamicComponent($props.node.expandedIcon ? 'span' : 'ChevronDown'), mergeProps({
    key: 1,
    "class": _ctx.cx('nodeToggleIcon')
  }, $options.getPTOptions('nodeToggleIcon')), null, 16, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.node.collapsedIcon ? 'span' : 'ChevronRight'), mergeProps({
    key: 2,
    "class": _ctx.cx('nodeToggleIcon')
  ...
  }, $options.getPTOptions('nodeIcon')), null, 16, ["node", "class"])) : $options.isComponentIcon($props.node.icon) ? (openBlock(), createBlock(resolveDynamicComponent($options.resolveIcon($props.node.icon)), mergeProps({
    key: 2,
    "class": _ctx.cx('nodeIcon')
  }, $options.getPTOptions('nodeIcon')), null, 16, ["class"])) : $props.node.icon ? (openBlock(), createElementBlock("span", mergeProps({
    key: 3,
    "class": [_ctx.cx('nodeIcon'), $props.node.icon]
  }, $options.getPTOptions('nodeIcon')), null, 16)) : createCommentVNode("", true), createElementVNode("span", mergeProps({
      ...
      return [createVNode(_component_InputText, {
        ...
        "default": withCtx(function () {
          return [renderSlot(_ctx.$slots, "filtericon", {
            ...
            return [createVNode(_component_Search, mergeProps({
