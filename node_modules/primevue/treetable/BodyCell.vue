        ...
        <div :class="cx('bodyCellContent')" v-bind="getColumnPT('bodyCellContent')">
            <button v-if="columnProp('expander')" v-ripple type="button" :class="cx('nodeToggleButton')" @click="toggle" :style="togglerStyle" tabindex="-1" v-bind="getColumnPT('nodeToggleButton')" data-pc-group-section="rowactionbutton">
                <template v-if="node.loading && loadingMode === 'icon'">
                    ...
                    <Spinner v-else spin :class="cx('nodeToggleIcon')" v-bind="ptm('nodetoggleicon')" />
                </template>
                <template v-else>
                    ...
                    <component v-else-if="expanded" :is="node.expandedIcon ? 'span' : 'ChevronDown'" :class="cx('nodeToggleIcon')" v-bind="getColumnPT('nodeToggleIcon')" />
                    <component v-else :is="node.collapsedIcon ? 'span' : 'ChevronRight'" :class="cx('nodeToggleIcon')" v-bind="getColumnPT('nodeToggleIcon')" />
                </template>
            </button>
            <Checkbox
