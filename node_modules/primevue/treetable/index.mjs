...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("td", mergeProps({
    ...
    key: 0
  })) : (openBlock(), createBlock(_component_Spinner, mergeProps({
    key: 1,
    spin: "",
    ...
    expanded: $props.expanded,
    "class": normalizeClass(_ctx.cx('nodeToggleIcon'))
  }, null, 8, ["node", "expanded", "class"])) : $props.expanded ? (openBlock(), createBlock(resolveDynamicComponent($props.node.expandedIcon ? 'span' : 'ChevronDown'), mergeProps({
    key: 2,
    "class": _ctx.cx('nodeToggleIcon')
  }, $options.getColumnPT('nodeToggleIcon')), null, 16, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.node.collapsedIcon ? 'span' : 'ChevronRight'), mergeProps({
    key: 3,
    "class": _ctx.cx('nodeToggleIcon')
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "default": withCtx(function () {
      return [_ctx.loading && _ctx.loadingMode === 'mask' ? (openBlock(), createElementBlock("div", mergeProps({
        ...
        return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.loadingIcon ? 'span' : 'Spinner'), mergeProps({
          spin: "",
